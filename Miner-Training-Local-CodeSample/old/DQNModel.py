...
class DQN: 
    ...
    def __init__(
            ...
            # epsilon = 0.01, #Epsilon - the exploration factor
    ...
    def act(self,state):
      ...
      if (random() < self.epsilon):
        ...
        # while self.check_action(a_chosen):
        #   a_chosen = randrange(self.action_space)
    ...
    #     if action == 0 and self.info.posx == 0: return True
    #     if action == 1 and self.info.posx == self.state.mapInfo.max_x: return True
    #     if action == 2 and self.info.posy == 0: return True
    #     if action == 3 and self.info.posy == self.state.mapInfo.max_y: return True
